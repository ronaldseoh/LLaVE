...
class LlavaMetaModel:
    ...
    def initialize_vision_modules(self, model_args, fsdp=None, cache_dir=None):
        ...
        self.config.alpha = getattr(model_args, "alpha", 0.5)
        self.config.logit_scale = getattr(model_args, "logit_scale", 50.0)
    ...
    def prepare_inputs_labels_for_multimodal(self, input_ids, position_ids, attention_mask, past_key_values, labels, images, modalities=["image"], image_sizes=None):
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            if num_images == 0:
                ...
                cur_input_embeds = torch.cat([cur_input_embeds_1, cur_image_features[0:0].to(cur_input_embeds_1.device)], dim=0)
