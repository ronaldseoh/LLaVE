...
class LLaVATrainer(Trainer):
    ...
    def create_optimizer(self):
        ...
        # rank0_print("*******opt_model**********", [n for n, p in opt_model.named_parameters() if (n in decay_parameters and p.requires_grad)])
        # rank0_print("*******opt_model**********", [n for n, p in opt_model.named_parameters() if (n not in decay_parameters and p.requires_grad)])
        if self.optimizer is None:
            ...
            lr_mapper["logit_scale"] = 1e-2
            lr_mapper["logit_bias"] = 1e-2
            if len(lr_mapper) > 0:
